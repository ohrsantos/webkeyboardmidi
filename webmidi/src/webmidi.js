(function(scope) {
  ...
  Output.prototype.send = function(status, data, timestamp) {
    ...
    ////if ( !Array.isArray(data) ) { data = [data]; console.log('webmidi.js::isArray', data);}

    var message = [];

      //console.log('webmidi.js::data: ', data);
    data.forEach(function(item){

    //console.log('webmidi.js::item:', item);
    var parsed = Math.floor(item); // mandatory because of "null"
    //console.log('webmidi.js::parsed: ', parsed);
